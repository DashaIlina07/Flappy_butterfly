...
main_sound = pygame.mixer.Sound("звуки и музыка/Feel-Good(chosic.com).mp3")
bg_sound = pygame.mixer.Sound("звуки и музыка/level1.mp3")
...
player_images = {
    "Птица": [pygame.image.load("персонажи/птицы 1.png"), pygame.image.load("персонажи/птицы 2.png"),
              pygame.image.load("персонажи/птицы 3.png"), pygame.image.load("персонажи/птицы death.png")],
    "Бабочка": [pygame.image.load("персонажи/бабочки 1.png"), pygame.image.load("персонажи/бабочки 2.png"),
                pygame.image.load("персонажи/бабочки 3.png"), pygame.image.load("персонажи/бабочки death.png")],
    "Пчела": [pygame.image.load("персонажи/пчелы1.png"), pygame.image.load("персонажи/пчелы 2.png"),
              pygame.image.load("персонажи/пчелы 3.png"), pygame.image.load("персонажи/пчелы dead.png")]
}
obstacle_image = pygame.image.load("фоны/obstacle.png")
...
def main_meno():
    ...
    if main_note or bg_note:
        ...
        sound_path = ""
    start_button = Button(380, 400, 650, 150, "", "кнопки/play.png",
                          "кнопки/play_hover.png", sound_path)
    quit_button = Button(380, 600, 650, 150, "", "кнопки/quit.png",
                         "кнопки/quit_hover.png", sound_path)
    options_button = Button(1200, 40, 150, 150, "", "кнопки/settings.png",
                            "кнопки/settings.png", sound_path)
    running = True
    ...
    while running:
        screen.fill((0, 0, 0))
        screen.blit(pygame.image.load("фоны/background.jpg"), (0, 0))

        image = pygame.image.load("буквы/f-no-bg-preview (carve.photos)_N.png").convert_alpha()
        new_image = pygame.transform.scale(image, (60, 100))
        screen.blit(new_image, (40, 40))
        image = pygame.image.load("буквы/L-no-bg-preview (carve,photos)_e.png").convert_alpha()
        new_image = pygame.transform.scale(image, (60, 100))
        screen.blit(new_image, (100, 40))
        image = pygame.image.load("буквы/a-fotor-bg-remover-2025021222143.png").convert_alpha()
        new_image = pygame.transform.scale(image, (60, 100))
        screen.blit(new_image, (160, 40))
        image = pygame.image.load("буквы/P-no-bg-preview (carve,photos)_e.png").convert_alpha()
        new_image = pygame.transform.scale(image, (60, 100))
        screen.blit(new_image, (220, 40))
        image = pygame.image.load("буквы/P-no-bg-preview (carve,photos)_e.png").convert_alpha()
        new_image = pygame.transform.scale(image, (60, 100))
        screen.blit(new_image, (280, 40))
        image = pygame.image.load("буквы/Y-no-bg-preview (carve,photos)_e.png").convert_alpha()
        new_image = pygame.transform.scale(image, (60, 100))
        screen.blit(new_image, (340, 40))
        image = pygame.image.load("буквы/a-fotor-bg-remover-2025021222143.png").convert_alpha()
        new_image = pygame.transform.scale(image, (60, 100))
        screen.blit(new_image, (160, 140))
        image = pygame.image.load("буквы/n.png").convert_alpha()
        new_image = pygame.transform.scale(image, (60, 100))
        screen.blit(new_image, (220, 140))
        image = pygame.image.load("буквы/i-no-bg-preview (carve,photos)_e.png").convert_alpha()
        new_image = pygame.transform.scale(image, (60, 100))
        screen.blit(new_image, (280, 140))
        image = pygame.image.load("буквы/m.png").convert_alpha()
        new_image = pygame.transform.scale(image, (60, 100))
        ...
        image = pygame.image.load("буквы/s.png").convert_alpha()
        new_image = pygame.transform.scale(image, (60, 100))
...
def dead(score):
    ...
    if main_note or bg_note:
        ...
        sound_path = ""
    setting_button = Button(10, 40, 150, 150, "", "кнопки/settings.png",
                          "кнопки/settings.png", sound_path)
    meno_button = Button(1200, 40, 150, 150, "",
                         "кнопки/дом-edited-free (carve,photos)_enhanced.png",
                         "кнопки/дом-edited-free (carve,photos)_enhanced.png", sound_path)
    retr_button = Button(550, 480, 250, 250, "", "кнопки/back.png",
                            "кнопки/back.png", "")
    ...
    while running:
        ...
        image = pygame.image.load("буквы/e.png").convert_alpha()
        new_image = pygame.transform.scale(image, (100, 140))
        screen.blit(new_image, (740, 150))
        image = pygame.image.load("буквы/i-no-bg-preview (carve,photos)_e.png").convert_alpha()
        new_image = pygame.transform.scale(image, (100, 140))
        screen.blit(new_image, (540, 150))
        image = pygame.image.load("буквы/d-no-bg-preview (carve,photos)_e.png").convert_alpha()
        new_image = pygame.transform.scale(image, (100, 140))
...
def setting_meno():
    ...
    music_button = Button(350, 250, 300, 200, "Music: On" if main_music else "Music: Off",
                          "кнопки/музыка-edited-free (carve,photos)_enhanced.png",
                          "кнопки/музыка-edited-free (carve,photos)_enhanced.png",
    ...
    while running:
        screen.fill((0, 0, 0))
        screen.blit(pygame.image.load("фоны/background.jpg"), (-300, 0))
...
def character_select_meno():
    ...
    difficulty_easy_button = Button(400, 200, 200, 70, "",
                                    "кнопки/level1.png", "кнопки/level1.png",
                                    sound_path, text_color=(0,0,0))
    difficulty_medium_button = Button(400, 300, 200, 70,
                                      "", "кнопки/level2.png", "кнопки/level2.png",
                                      sound_path, text_color=(0,0,0))
    difficulty_hard_button = Button(400, 400, 200, 70, "", "кнопки/level3.png",
                                    "кнопки/level3.png", sound_path, text_color=(0,0,0))

    character_butterfly_button = Button(700, 200, 120, 80, "", "персонажи/бабочки 1.png",
                                        "персонажи/бабочки 2.png", sound_path, text_color=(0,0,0))
    character_bee_button = Button(700, 300, 120, 80, "", "персонажи/пчелы1.png",
                                  "персонажи/пчелы 2.png", sound_path, text_color=(0,0,0))
    character_bird_button = Button(700, 400, 120, 80, "", "персонажи/птицы 1.png",
                                   "персонажи/птицы 2.png", sound_path, text_color=(0,0,0))

    start_level_button = Button(width // 2 - 150, 600, 300, 100, "", "кнопки/play.png",
                                "кнопки/play_hover.png", sound_path)
    running = True
...
class Level:
    def __init__(self, level_number, screen, width, height, player_images, obstacle_image, main_sound, bg_sound,
                 difficulty, selected_character, bg_music, save_result_to_txt, main_meno,
                 dead, main_note, bg_note, score):
        ...
        self.obstacle_image_scaled = pygame.transform.scale(obstacle_image,
                                                            (self.obstacle_width, obstacle_image.get_height()))
        ...
        self.conflict = [
                    pygame.image.load("фоны/взрыв1.png"),
                    pygame.image.load("фоны/взрыв2.png"),
                    pygame.image.load("фоны/взрыв2.5.png"),
                    pygame.image.load("фоны/взрыв3.png"),
                    pygame.image.load("фоны/взрыв4.png"),
                    pygame.image.load("фоны/взрыв5.png"),
        ...
        self.fon = pygame.image.load('фоны/level1_background.png') # Assuming same background for all levels
    ...
    def run(self):
        ...
        while running:
            ...
            for event in pygame.event.get():
                ...
                if event.type == pygame.KEYDOWN:
                    ...
                    if event.key == pygame.K_s:
                        self.save_result_to_txt("Игрок", self.score, self.difficulty,
                                                self.selected_character) # Call save_result_to_txt
            ...
            scaled_upper_obstacle = pygame.transform.scale(self.obstacle_image,
                                                           (self.obstacle_width, self.obstacle_upper_rect.height))
            ...
            scaled_lower_obstacle = pygame.transform.scale(self.obstacle_image,
...
def run_level(level_num):
    global screen, width, height, player_images, obstacle_image, main_sound, bg_sound, difficulty, selected_character,\
        bg_music, save_result_to_txt, main_meno, dead, main_note, bg_note, score
    level_instance = Level(level_num, screen, width, height, player_images, obstacle_image, main_sound, bg_sound,
                           difficulty, selected_character, bg_music, save_result_to_txt, main_meno, dead, main_note,
                           bg_note, score)
    level_instance.run()
